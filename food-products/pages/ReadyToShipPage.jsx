...
const ReadyToShipPage = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const res = await productService.getReadyToShip();
    ...
    <div className='bg-white min-h-screen'>
      ...
      <div className='pt-[110px] pb-[80px] px-[30px] max-md:px-[16px] max-w-[1200px] mx-auto'>
        <div className='text-center mb-[60px]'>
          <p className='font-[amma3] text-[11px] text-gray-400 uppercase tracking-[4px] mb-[12px]'>Dispatched Within 24 Hours</p>
          <h1 className='font-[amma4] text-[36px] md:text-[48px] text-gray-900 uppercase tracking-[6px] mb-[16px]'>Ready to Ship</h1>
          <div className='w-[40px] h-[1px] bg-gray-900 mx-auto mb-[16px]'></div>
          <p className='font-[amma3] text-[13px] text-gray-500 uppercase tracking-[2px] max-w-[500px] mx-auto'>
            Curated styles prepared for immediate dispatch. No wait times.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className='text-center py-[60px]'>
            <p className='font-[amma3] text-gray-400 text-[14px]'>No ready-to-ship items found.</p>
          </div>
        ) : (
              ...
              return (
                <div key={product.id} className='group cursor-pointer'>
                  <div className='relative overflow-hidden bg-gray-50 aspect-[3/4] mb-[16px]'>
                    ...
                    <div className='absolute top-[12px] left-[12px] px-[10px] py-[4px] text-[10px] font-[amma3] tracking-[2px] uppercase bg-gray-900 text-white'>
                      READY TO SHIP
                    </div>
